...
def read_result_files(filenames, filter_expression=None, include_fields_as_scalars=False, vector_start_time=-inf,
                      vector_end_time=inf):
    """
...
def get_results(filter_or_dataframe="", row_types=None, omit_unused_columns=True, include_fields_as_scalars=False,
...
@_guarded_result_query_func
def get_runs(filter_or_dataframe="", include_runattrs=False, include_itervars=False, include_param_assignments=False,
    ...
    if type(filter_or_dataframe) is str:
        ...
        df = _pivot_metadata(runs, metadf, include_runattrs, include_itervars, include_param_assignments,
                             include_config_entries)
...
@_guarded_result_query_func
def get_runattrs(filter_or_dataframe="", include_runattrs=False, include_itervars=False,
    ...
    if type(filter_or_dataframe) is str:
        ...
        df = _pivot_metadata(runattrs, metadf, include_runattrs, include_itervars, include_param_assignments,
                             include_config_entries)
        df.dropna(axis='columns', how='all', inplace=True)
...
@_guarded_result_query_func
def get_itervars(filter_or_dataframe="", include_runattrs=False, include_itervars=False,
                 include_param_assignments=False, include_config_entries=False):
    """
    ...
    if type(filter_or_dataframe) is str:
        ...
        df = _pivot_metadata(itervars, metadf, include_runattrs, include_itervars, include_param_assignments,
                             include_config_entries)
        df.dropna(axis='columns', how='all', inplace=True)
...
@_guarded_result_query_func
def get_scalars(filter_or_dataframe="", include_attrs=False, include_fields=False, include_runattrs=False,
                include_itervars=False, include_param_assignments=False, include_config_entries=False):
    """
...
@_guarded_result_query_func
def get_parameters(filter_or_dataframe="", include_attrs=False, include_runattrs=False, include_itervars=False,
                   include_param_assignments=False, include_config_entries=False):
    """
...
@_guarded_result_query_func
def get_vectors(filter_or_dataframe="", include_attrs=False, include_runattrs=False, include_itervars=False,
                include_param_assignments=False, include_config_entries=False, start_time=-inf, end_time=inf):
    """
...
@_guarded_result_query_func
def get_statistics(filter_or_dataframe="", include_attrs=False, include_runattrs=False, include_itervars=False,
                   include_param_assignments=False, include_config_entries=False):
    """
...
@_guarded_result_query_func
def get_histograms(filter_or_dataframe="", include_attrs=False, include_runattrs=False, include_itervars=False,
                   include_param_assignments=False, include_config_entries=False):
    """
...
@_guarded_result_query_func
def get_config_entries(filter_or_dataframe, include_runattrs=False, include_itervars=False,
                       include_param_assignments=False, include_config_entries=False):
    """
    ...
    if type(filter_or_dataframe) is str:
        ...
        df = _pivot_metadata(configentries, metadf, include_runattrs, include_itervars, include_param_assignments,
                             include_config_entries)
        df.dropna(axis='columns', how='all', inplace=True)
...
@_guarded_result_query_func
def get_param_assignments(filter_or_dataframe, include_runattrs=False, include_itervars=False,
                          include_param_assignments=False, include_config_entries=False):
    """
    ...
    if type(filter_or_dataframe) is str:
        ...
        df = _pivot_metadata(paramassignments, metadf, include_runattrs, include_itervars, include_param_assignments,
                             include_config_entries)
        df.dropna(axis='columns', how='all', inplace=True)
