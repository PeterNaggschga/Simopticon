...
def __lldb_init_module(debugger, internal_dict):
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".simtime_t_SummaryProvider omnetpp::simtime_t")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cDisplayString_SummaryProvider omnetpp::cDisplayString")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cNamedObject_SummaryProvider omnetpp::cNamedObject")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cOwnedObject_SummaryProvider omnetpp::cOwnedObject")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cOwnedObject_SummaryProvider omnetpp::cNoncopyableOwnedObject")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cOwnedObject_SummaryProvider omnetpp::cDefaultOwner")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cComponentType_SummaryProvider omnetpp::cComponentType")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cComponentType_SummaryProvider omnetpp::cModuleType")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cComponentType_SummaryProvider omnetpp::cDynamicModuleType")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cComponent_SummaryProvider omnetpp::cComponent")
    debugger.HandleCommand("type summary add -w omnetpp -F " + __name__ + ".cModule_SummaryProvider omnetpp::cModule")
    debugger.HandleCommand(
        "type summary add -w omnetpp -F " + __name__ + ".cModule_SummaryProvider omnetpp::cSimpleModule")
